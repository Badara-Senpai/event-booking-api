...
func cancelRegistration(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not unregister user to event"})
		return
	}

	context.JSON(http.StatusOK, gin.H{"message": "Unregistered to the event successfully"})
}
